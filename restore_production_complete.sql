-- =========================================================================
-- MANAS RESTAURANT & RESORT — MASTER PRODUCTION RECOVERY & SYNC SCRIPT
-- Restores all 160 Menu Items, Tables, RLS Policies, Realtime Channels & Admin Roles
-- =========================================================================
...
ALTER TABLE public.menu_items ALTER COLUMN image_url DROP NOT NULL;
...
-- 4. Create delivery_partners table
...
-- 7. Grant Table Access Permissions to anon and authenticated Roles
GRANT ALL ON TABLE public.menu_items TO anon, authenticated, service_role, postgres;
GRANT ALL ON TABLE public.orders TO anon, authenticated, service_role, postgres;
GRANT ALL ON TABLE public.contact_messages TO anon, authenticated, service_role, postgres;
...
GRANT ALL ON TABLE public.delivery_partners TO anon, authenticated, service_role, postgres;
...
DROP POLICY IF EXISTS "Everyone can read contact messages" ON public.contact_messages;
CREATE POLICY "Everyone can read contact messages" ON public.contact_messages FOR SELECT USING (true);

DROP POLICY IF EXISTS "Everyone can delete contact messages" ON public.contact_messages;
...
-- 11. Auto-Assign Admin Permissions for troxin694@gmail.com
...
-- 12. Populate All 160 Food Items
